"""
Schema for channeldata.json files found in anaconda.org channels
"""
...
class ChannelDataPackage(ExtrasForbiddenModel):
    ...
    dev_url: Iterable[AnyUrl] | None = None
    "The URL to the development page of the package"
    doc_url: Iterable[AnyUrl] | None = None
    "The URL to the documentation page of the package"
    home: Iterable[AnyUrl] | None = None
    "The URL to the homepage of the package"
    source_url: Iterable[AnyUrl] | None = None
